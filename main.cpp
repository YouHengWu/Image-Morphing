...
void onMouse2 (int Event, int x, int y, int flags, void* param)
{
    if (Drawing_Flag % 2 == 1 && Drawing_Flag > 0) {
        if (Event == CV_EVENT_LBUTTONDOWN) {
            printf("Right Line Start Point：( %d, %d) \n", x, y);

            Two_lines.Right_Line.Begin.x = x;
            Two_lines.Right_Line.Begin.y = y;
        }
        if (Event == CV_EVENT_LBUTTONUP) {
            printf("Right Line End Point：( %d, %d) \n", x, y);
...
int main() {
    ...
    cout << "Choose First image (Input an odd integer number between 1 to 14)：";
    cin >> First;
    while (First % 2 == 0 || First < 1 || First > 14) {
        cout << "Hey！ What are you doing？ Please follow the instruction. :(\n";
        cout << "Choose First image (Input an odd integer number between 1 to 14)：";
        cin >> First;
    }

    cout << "Choose Second image (Input an even integer number which is the number of first image + 1)：";
    cin >> Second;
    ...
    cout << "Input Frames (Input an integer number greater than 0)：";
    cin >> frames;
    while (frames <= 0) {
        cout << "Hey！ What are you doing？ Please follow the instruction. :(\n";
        cout << "Choose Second image (Input an even integer number which is the number of first image + 1)：";
    ...
    /*
    cout << "Choose constant a (Input an integer number between 0 to 2)：";
    cin >> a;
    while (a < 0 || a > 2) {
        cout << "Hey！ What are you doing？ Please follow the instruction. :(\n";
        cout << "Choose Second image (Input an even integer number which is the number of first image + 1)：";
    ...
    cout << "Choose constant b (Input an integer number between 0 to 2)：";
    cin >> b;
    while (b < 0 || b > 2) {
        cout << "Hey！ What are you doing？ Please follow the instruction. :(\n";
        cout << "Choose Second image (Input an even integer number which is the number of first image + 1)：";
    ...
    cout << "Choose constant p (Input an integer number between 0 to 2)：";
    cin >> p;
    while (p < 0 || p > 2) {
        cout << "Hey！ What are you doing？ Please follow the instruction. :(\n";
        cout << "Choose Second image (Input an even integer number which is the number of first image + 1)：";
